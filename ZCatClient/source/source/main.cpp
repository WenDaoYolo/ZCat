            ...
            if(view->data.des_id==cur_view_friend->data.id||view->data.sou_id==cur_view_friend->data.id)
            {
                ...
                if(cur_user.id==view->data.sou_id)
                {
                    ...
                    if(mine_msg.rect.y>=75&&mine_msg.rect.y<575)
                    {
                        ...
                        if(total_weight<255)
                        {
                            mine_msg.rect.w=total_weight+15;
                            mine_msg.rect.x=mine_msg_rect.x+(225-total_weight);
                            mine_msg.Draw(rdr,225);
                        }
                        else
                        {
                            mine_msg.rect.w=mine_msg_rect.w;
                            mine_msg.rect.x=mine_msg_rect.x;
                            mine_msg.Draw(rdr,225);
                        }
                    }    
                }
                else
                {
                    ...
                    if(target_msg.rect.y>=75&&target_msg.rect.y<575)
                    {
                        ...
                        if(total_weight<255)
                        {
                            target_msg.rect.w=total_weight+15;
                            target_msg.Draw(rdr,225);
                        }
                        else
                        {
                            target_msg.rect.w=target_msg_rect.w;
                            target_msg.Draw(rdr,225);
                        }
                    }
                }
